...
*	for Motorola freeware assemblers
*----------------------------------------------------------------------*/
...
int		ERLflag = 0;			/* error listing 0=nolist, 1=list 		*/
...
int 	Oflag = 0;				/* output listing file */
int		FdCount = 0;			/* INCLUDE files "stack" pointer 		*/
								/* ver TER_2.0 June 17, 1989 			*/
char 	InclFName[MAXBUF]={0};	/* current INCLUDE file name 			*/
char 	ErrorFile[80]={0};		/* error file name 						*/
char 	OutputFile[80]={0};		/* listing output file */
char 	cfbuf[80];				/* buffer for current file name 		*/
...
struct nlist { 			/* basic symbol table entry */
	...
	int def2;		/* value assign by assembler, e.g.
				defined this pass? */
